...
public class AssinmentQ3 {
    ...
    public static void main(String[] args) {
        ...
        Trader trader1 = new Trader("kishan Agrawal","Pune");
        Trader trader2 = new Trader("amit","mumbai");
        Trader trader3 = new Trader("Atharva patil","akola");
        Trader trader4 = new Trader("baburao ","akola");
